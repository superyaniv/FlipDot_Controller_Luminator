...
class FlipDot_Controller_Class:
	...
	displayRows = 7
	currentDisplayState = [[[0 for s in range(displaySegments)] for c in range(columns_per_Segment)] for r in range(displayRows)]
	flipDelay = .005
	...
	def updateDisplay(self, textMessage):
		...
		for ch in range(0, self.displaySegments):
